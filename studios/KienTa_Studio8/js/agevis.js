...
AgeVis.prototype.initVis = function () {
  ...
  // Scales and axes
  vis.x = d3.scaleLinear().range([0, vis.width]).domain([0, 99]);
  ...
  vis.agePath = vis.svg.append("path").attr("class", "area area-age");
...
AgeVis.prototype.wrangleData = function () {
  ...
  // ...
  let votesPerAge = d3.range(0, 100).map(function (i) {
    return 0;
  });
...
AgeVis.prototype.updateVis = function () {
  ...
  vis.agePath.datum(vis.displayData).transition().attr("d", vis.area);
